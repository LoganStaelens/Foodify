...
public class AdminWindow extends Window implements Initializable, IAddIngredientPopupListener, IAddStepPopupListener {
    ...
    @FXML
    private TableColumn<Ingredient, Float> cr_ing_quantity_column;
    @FXML
    ...
    @FXML
    private TableColumn<?, ?> lr_column_complexity;

    @FXML
    private TableColumn<?, ?> lr_column_id;

    @FXML
    private TableColumn<?, ?> lr_column_tags;

    @FXML
    private TableColumn<?, ?> lr_column_title;

    @FXML
    private TextField lr_input_search_bar;

    @FXML
    private TableView<?> lr_tableview;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        cr_ing_quantity_column.setCellValueFactory(new PropertyValueFactory<Ingredient, Float>("quantity"));
